...
// define what fields a login object will have
type Login struct {
...
func (x *Login) GetAccessTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Login) GetRefreshTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
...
var file_login_proto_rawDesc = []byte{
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x42, 0x16, 0x5a, 0x14, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x42,
	0x61, 0x6e, 0x6b, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
