...
func (store *Store) execTx(ctx context.Context, fn func(*Queries) error) error { // unexported function as it starts with a lowercase letter - will create exported functions for each transaction
